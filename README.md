...
Поскольку мы используем старый образ Nginx то нужно указать ссылки на архивные серкала и использовать менеджер пакетов apt-get, после чего всё устанавливается корректно.
